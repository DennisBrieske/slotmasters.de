<x-layout>
    <div class="container">
        <h1 class="mt-2">Impressum</h1><br>
        <h4>Kontakt zum Seitenbetreiber bekommen Sie hier</h4>

        <div class="bd-example">
            <address>
                <strong>Dennis Brieske</strong><br/>
                Hinter den Höfen 14<br/>
                21502 Hamwarde<br/>
                <abbr title="Phone">Tel:</abbr> <b><u>nach schriftlicher
                        Rücksprache</u></b>
            </address>

            <address>
                <strong>eMail</strong><br/>
                <a href="mailto:kontakt@slotmasters.de">kontakt@slotmasters.de</a>
            </address>
        </div>
        ...
        <p>
            ...
            von Ihnen verwendeten Webbrowser sowie Ihr Betriebssystem
            ...
            zu verbessern. Das Erfassen dieser Informationen ist notwendig, um den
            Inhalt der Webseite korrekt ausliefern zu können.
        </p>


        <p>
            Die Nutzung der Webseite ist grundsätzlich ohne Angabe personenbezogener
            Daten möglich. Soweit personenbezogene Daten (beispielsweise Name,
        ...
        <p>
            ...
            ist, um Ihnen die Inanspruchnahme des Webangebots zu
            ...
            Ihrer Anfrage oder Abwicklung eines Vertrags)
        ...
        <p>
            ...
            auf die rechtsverletzende Site entfernen.
        </p>
        ...
        <p>
            Dieses Impressum wurde mit Hilfe des <a
                ...
                target="_blank"
                rel="noreferrer noopener">Impressum-Generators</a> von <a
                href="http://www.hensche.de/Rechtsanwalt_Arbeitsrecht_Berlin.html"
                target="_blank" rel="noreferrer noopener">HENSCHE
                Rechtsanwälte</a> erstellt.
        </p>
    </div>
</x-layout>
